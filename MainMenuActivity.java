...
public class MainMenuActivity extends Activity {
    ...
    private void switchToMainView(){
    	...
    	insertButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				MainMenuActivity.this.switchToInsertView();
			}    		
    	});
    	...
    	ImageView medieval = (ImageView) findViewById(R.id.main_imageViewnight);
    ...
    private void switchToGalleryView(String type){
    	try {
    		...
    		backButton.setOnClickListener(new OnClickListener(){
				...
				@Override
				public void onClick(View arg0) {
					MainMenuActivity.this.switchToMainView();					
				}});
			...
			for (int i = 0; i < costumes.length; i++) {
				...
				verticalLayout.setOnClickListener(new CostumeClick(this,costumes[i]));
    ...
    public void switchToCostumeView(final Costume aCostume){
    	...
    	back.setOnClickListener(new OnClickListener(){
			...
			@Override
			public void onClick(View arg0) {
				MainMenuActivity.this.switchToGalleryView(aCostume.getType());
